...
def two_uint8_to_uint16(uint8_hi=0, uint8_lo=0) -> int:
...
def error_function_not_supported(rx_adu=b'') -> bytes:
...
def modbus_tcp_server_fun_3(rx_adu=b'') -> bytes:
...
def modbus_tcp_server_fun_16(rx_adu=b'') -> bytes:
